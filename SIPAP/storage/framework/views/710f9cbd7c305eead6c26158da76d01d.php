        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border-l-4 border-[#38BDF8] p-5 flex items-center justify-between">
                <div class="space-y-1.5">
                    ...
                    <h3 class="text-3xl font-bold text-[#0C4A6E]"><?php echo e($totalAlat); ?></h3>
                    <p class="text-[11px] text-[#94A3B8] font-medium"><?php echo e($alatTersedia); ?> jenis tersedia</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border-l-4 border-[#F59E0B] p-5 flex items-center justify-between">
                <div class="space-y-1.5">
                    ...
                    <h3 class="text-3xl font-bold text-[#0C4A6E]"><?php echo e($peminjamanAktif); ?></h3>
            ...
            <div class="bg-white rounded-xl shadow-sm border-l-4 border-[#EF4444] p-5 flex items-center justify-between">
                <div class="space-y-1.5">
                    ...
                    <h3 class="text-3xl font-bold <?php echo e($menungguKonfirmasi > 0 ? 'text-[#EF4444]' : 'text-[#0C4A6E]'); ?>"><?php echo e($menungguKonfirmasi); ?></h3>
            ...
            <div class="bg-white rounded-xl shadow-sm border-l-4 border-[#10B981] p-5 flex items-center justify-between">
                <div class="space-y-1.5">
                    ...
                    <h3 class="text-3xl font-bold text-[#0C4A6E]"><?php echo e($selesaiBulanIni); ?></h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
                <div class="p-5 border-b border-gray-100 flex justify-between items-center bg-white">
                    ...
                    <a href="<?php echo e(route('peminjaman.index')); ?>" class="text-[#0EA5E9] hover:text-[#0369A1] text-xs font-semibold transition">Lihat Semua</a>
                </div>
                ...
                <div class="overflow-x-auto flex-1">
                    <table class="min-w-full divide-y divide-gray-100 text-left text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            <?php $__empty_1 = true; $__currentLoopData = $upcomingPeminjamans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50/50 transition duration-150">
                                <td class="px-6 py-4">
                                    <div class="font-medium text-[#334155]"><?php echo e($item->user->name ?? 'N/A'); ?></div>
                                    <div class="text-[10px] text-[#94A3B8] tracking-wide"><?php echo e(ucfirst($item->user->role ?? 'mahasiswa')); ?></div>
                                </td>
                                <td class="px-6 py-4 text-slate-600"><?php echo e($item->alat->nama_alat ?? 'None'); ?></td>
                                <td class="px-6 py-4 text-slate-500"><?php echo e($item->tgl_pinjam->format('d M Y')); ?></td>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
                <div class="p-5 border-b border-gray-100 flex justify-between items-center bg-white">
                    ...
                    <a href="<?php echo e(route('pengembalian.index')); ?>" class="text-[#0EA5E9] hover:text-[#0369A1] text-xs font-semibold transition">Lihat Semua</a>
                </div>
                ...
                <div class="overflow-x-auto flex-1">
                    <table class="min-w-full divide-y divide-gray-100 text-left text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            <?php $__empty_1 = true; $__currentLoopData = $pengembaliansPending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-slate-50/50 transition duration-150">
                                <td class="px-6 py-4">
                                    <div class="font-medium text-[#334155]"><?php echo e($item->user->name ?? 'N/A'); ?></div>
                                </td>
                                <td class="px-6 py-4 text-slate-600"><?php echo e($item->alat->nama_alat ?? 'None'); ?></td>
                                <td class="px-6 py-4 text-slate-500"><?php echo e($item->tgl_kembali_rencana->format('d M Y')); ?></td>
                                <td class="px-6 py-4 text-right">
                                    <a href="<?php echo e(route('pengembalian.index')); ?>" class="inline-flex items-center justify-center bg-[#0EA5E9] text-white text-xs font-medium rounded-lg px-3.5 py-1.5 hover:bg-[#0369A1] transition active:scale-95">
                                        Konfirmasi
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UAS Pak Arifin\SIPAP\resources\views/dashboard.blade.php ENDPATH**/ ?>