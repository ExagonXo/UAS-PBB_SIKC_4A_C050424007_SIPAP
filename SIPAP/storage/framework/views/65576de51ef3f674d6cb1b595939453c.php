                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="input-field w-full pl-9 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm text-[#334155] placeholder-slate-300 bg-slate-50/50 transition <?php $__errorArgs = ['email'];
                ...
                <div x-data="{ showPass: false }">
                    <div class="flex items-center justify-between mb-1.5">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-[10px] text-[#0EA5E9] hover:text-[#0369A1] font-medium transition">
                                Lupa kata sandi?
                            </a>
                        <?php endif; ?>
                    </div>
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                            class="input-field w-full pl-9 pr-10 py-2.5 rounded-xl border border-gray-200 text-sm text-[#334155] placeholder-slate-300 bg-slate-50/50 transition <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php unset($message);
...
<?php /**PATH D:\UAS Pak Arifin\SIPAP\resources\views/auth/login.blade.php ENDPATH**/ ?>